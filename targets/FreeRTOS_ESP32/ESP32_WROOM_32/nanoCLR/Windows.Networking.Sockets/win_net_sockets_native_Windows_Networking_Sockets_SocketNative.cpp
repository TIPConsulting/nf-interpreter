...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::socket___STATIC__I4__I4__I4__I4(
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::bind___STATIC__VOID__OBJECT__SZARRAY_U1(
    CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    connect___STATIC__VOID__OBJECT__SZARRAY_U1__BOOLEAN(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    send___STATIC__I4__OBJECT__SZARRAY_U1__I4__I4__I4__I4(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    recv___STATIC__I4__OBJECT__SZARRAY_U1__I4__I4__I4__I4(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::listen___STATIC__VOID__OBJECT__I4(
    CLR_RT_StackFrame &stack)
{
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::accept___STATIC__I4__OBJECT(
    CLR_RT_StackFrame &stack)
{
    NATIVE_PROFILE_CLR_NETWORK();
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    shutdown___STATIC__VOID__OBJECT__I4__BYREF_I4(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    sendto___STATIC__I4__OBJECT__SZARRAY_U1__I4__I4__I4__I4__SZARRAY_U1(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    recvfrom___STATIC__I4__OBJECT__SZARRAY_U1__I4__I4__I4__I4__BYREF_SZARRAY_U1(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    getpeername___STATIC__VOID__OBJECT__BYREF_SZARRAY_U1(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    getsockname___STATIC__VOID__OBJECT__BYREF_SZARRAY_U1(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    getsockopt___STATIC__VOID__OBJECT__I4__I4__SZARRAY_U1(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    setsockopt___STATIC__VOID__OBJECT__I4__I4__SZARRAY_U1(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::
    ioctl___STATIC__VOID__OBJECT__U4__BYREF_U4(CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::BindConnectHelper(
    CLR_RT_StackFrame &stack,
    bool fBind)
{
    NATIVE_PROFILE_CLR_NETWORK();
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::MarshalSockAddress(
    ...
    CLR_UINT32 addrLenSrc)
{
    ...
    CLR_RT_HeapBlock blkArr;
    blkArr.SetObjectReference(NULL);
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::MarshalSockAddress(
    ...
    CLR_UINT32 &addrLen,
    const CLR_RT_HeapBlock &blkSockAddress)
{
    NATIVE_PROFILE_CLR_NETWORK();
    NANOCLR_HEADER();
    ...
    if (ptrSockAddress->m_numOfElements > addrLen)
...
// HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::SendRecvHelper( CLR_RT_StackFrame&
// stack, bool fSend, bool fAddress )
// {
//     NATIVE_PROFILE_CLR_NETWORK();
//     NANOCLR_HEADER();
...
//             NANOCLR_CHECK_HRESULT(g_CLR_RT_ExecutionEngine.WaitEvents( stack.m_owningThread, *timeout, Event_Socket,
//             fRes ));
//         }
...
HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::SockNameHelper(
    CLR_RT_StackFrame &stack,
    bool fPeer)
{
    NATIVE_PROFILE_CLR_NETWORK();
...
void Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::ThrowError(
    CLR_RT_StackFrame &stack,
    CLR_INT32 errorCode)
{
    NATIVE_PROFILE_CLR_NETWORK();
    ...
    // if((Library_corlib_native_System_Exception::CreateInstance( res, g_CLR_RT_WellKnownTypes.m_SocketException,
    // CLR_E_FAIL, &stack )) == S_OK)
    // {
    //     res.Dereference()[ Library_system_sockets_System_Net_Sockets_SocketException::FIELD___errorCode ].SetInteger(
    //     errorCode );
    // }
}

HRESULT Library_win_net_sockets_native_Windows_Networking_Sockets_SocketNative::ThrowOnError(
    CLR_RT_StackFrame &stack,
    CLR_INT32 res)
{
    NATIVE_PROFILE_CLR_NETWORK();
