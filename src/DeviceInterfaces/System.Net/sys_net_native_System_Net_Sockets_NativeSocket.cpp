...
HRESULT Library_sys_net_native_System_Net_Sockets_NativeSocket::send___STATIC__I4__OBJECT__SZARRAY_U1__I4__I4__I4__I4(
    CLR_RT_StackFrame &stack)
{
...
HRESULT Library_sys_net_native_System_Net_Sockets_NativeSocket::getsockopt___STATIC__VOID__OBJECT__I4__I4__SZARRAY_U1(
    CLR_RT_StackFrame &stack)
{
    NATIVE_PROFILE_CLR_NETWORK();
...
HRESULT Library_sys_net_native_System_Net_Sockets_NativeSocket::setsockopt___STATIC__VOID__OBJECT__I4__I4__SZARRAY_U1(
    CLR_RT_StackFrame &stack)
{
    NATIVE_PROFILE_CLR_NETWORK();
...

    {
        ...
        *pRes = src->sin_addr.S_un.S_addr;
        ...
        ipEndPointHbObj[Library_sys_net_native_System_Net_IPEndPoint::FIELD___port].NumericByRef().s4 =
            SOCK_ntohs(src->sin_port);

        // set IPEndPoint address with IPAddress heap block object
        ipEndPointHbObj[Library_sys_net_native_System_Net_IPEndPoint::FIELD___address].SetObjectReference(
            ipAddressHbObj);
    }
...
HRESULT Library_sys_net_native_System_Net_Sockets_NativeSocket::SendRecvHelper(
    CLR_RT_StackFrame &stack,
    bool fSend,
    bool fAddress)
{
