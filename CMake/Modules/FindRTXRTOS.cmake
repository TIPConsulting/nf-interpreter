...
list(APPEND RTXRTOS_INCLUDE_DIRS ${CMAKE_BINARY_DIR}/RTXRTOS_Source/CMSIS/RTOS/RTX/INC)
list(APPEND RTXRTOS_INCLUDE_DIRS ${CMAKE_BINARY_DIR}/RTXRTOS_Source/CMSIS/RTOS/RTX/SRC)
...
foreach(SRC_FILE ${RTXRTOS_SRCS})
    ...
    find_file(RTXRTOS_SRC_FILE ${SRC_FILE}
        PATHS ${CMAKE_BINARY_DIR}/RTXRTOS_Source/CMSIS/RTOS/RTX/SRC ${CMAKE_BINARY_DIR}/RTXRTOS_Source/CMSIS/RTOS/Template/CPP
